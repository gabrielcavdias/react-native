  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ alignItems: "center" }}>
        <Image
          source={{
            uri: "https://images.pexels.com/photos/53404/scale-diet-fat-health-53404.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
          }}
          style={styles.img}
        />
      </View>
      ...
      <View>
        <Text style={{ ...styles.result, ...styles.text }}>
