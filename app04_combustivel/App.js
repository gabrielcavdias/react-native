  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ alignItems: "center" }}>
        <Image
          source={{
            uri: "https://images.pexels.com/photos/9796/car-refill-transportation-transport.jpg?cs=srgb&dl=pexels-skitterphoto-9796.jpg&fm=jpg",
          }}
          style={styles.img}
        />
      </View>
      <TextInput
        ...
        value={etanol}
        onChangeText={txt => setEtanol(txt.replace(/[^0-9-,-.]/g, ""))}
      />
      <TextInput
        style={styles.input}
        placeholderTextColor="#777"
        ...
        value={gasolina}
        onChangeText={txt => setGasolina(txt.replace(/[^0-9-,-.]/g, ""))}
      />
      <View style={{ alignItems: "center" }}>
        <Pressable
          style={styles.button}
